...
Fabric_Client.newDefaultKeyValueStore({ path: store_path
    ...
    secret_ubp = ubp.secret
    // next we need to enroll the user with CA server
    console.log('Successfully registered user1 - secret:'+ secret_ibm);
    console.log('Successfully registered user1 - secret:'+ secret_lotus);
    console.log('Successfully registered user1 - secret:'+ secret_ubp);

    return fabric_ca_client
        .enroll({enrollmentID: 'user1', enrollmentSecret: secret_ibm})
            .then(()=>{

    return fabric_ca_client
        .enroll({enrollmentID: 'user1', enrollmentSecret: secret_lotus})
            .then(()=>{  

    return fabric_ca_client
        .enroll({enrollmentID: 'user1', enrollmentSecret: secret_ubp})
            .then(()=>{
